...
{
    public class DataTableManager<Source>
    {
        public DataTableResult<Source> LoadTable(DtParameters dtParameters, List<Source> resultData, int TotalCount)
        {
            ...
            resultData = orderAscendingDirection ? resultData.AsQueryable().OrderByDynamic(orderCriteria, DtOrderDir.Asc).ToList() : resultData.AsQueryable().OrderByDynamic(orderCriteria, DtOrderDir.Desc).ToList();

            return new DataTableResult<Source>
            {
                Data = resultData,
                DtParameters = dtParameters,
                FilteredResultsCount = resultData.Count,
                TotalResultsCount = TotalCount
            };
        }
    }

    public class DataTableResult<Source>
    {
