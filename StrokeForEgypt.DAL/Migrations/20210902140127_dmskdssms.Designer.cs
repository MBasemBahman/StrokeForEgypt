...
namespace StrokeForEgypt.DAL.Migrations
{
    ...
    [Migration("20210902140127_dmskdssms")]
    partial class dmskdssms
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StrokeForEgypt.Entity.AccountEntity.AccountPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("StrokeForEgypt.Entity.BookingEntity.Booking", b =>
                {
                    ...
                    b.Property<int?>("Fk_AccountPayment")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Fk_AccountPayment")
                        .IsUnique()
                        .HasFilter("[Fk_AccountPayment] IS NOT NULL");
            ...
            modelBuilder.Entity("StrokeForEgypt.Entity.BookingEntity.Booking", b =>
                {
                    ...
                    b.HasOne("StrokeForEgypt.Entity.AccountEntity.AccountPayment", "AccountPayment")
                        .WithOne("Booking")
                        .HasForeignKey("StrokeForEgypt.Entity.BookingEntity.Booking", "Fk_AccountPayment");
